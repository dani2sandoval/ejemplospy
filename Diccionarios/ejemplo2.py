...
#utilizar como clave el nombre de productos y como valor el precio del mismo. #Desarrollar además las funciones de:
#1) Imprimir en forma completa el diccionario
#2) Imprimi solo los artículos con precio superior a 100.
